<div class="mb-3">
    ...
    <input type="number" name="reservation_id" id="reservation_id"
           value="{{ old('reservation_id', $reservationTax->reservation_id ?? '') }}"
...
<div class="mb-3">
    ...
    <input type="number" name="tax_id" id="tax_id"
           value="{{ old('tax_id', $reservationTax->tax_id ?? '') }}"
...
<div class="mb-3">
    ...
    <input type="text" name="type" id="type"
           value="{{ old('type', $reservationTax->type ?? '') }}"
...
<div class="mb-3">
    ...
    <input type="number" name="value" id="value"
           value="{{ old('value', $reservationTax->value ?? '') }}"
...
<div class="mb-3">
    ...
    <input type="number" name="price" id="price"
           value="{{ old('price', $reservationTax->price ?? '') }}"
