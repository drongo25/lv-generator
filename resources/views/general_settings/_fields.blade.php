<div class="mb-3">
    ...
    <input type="text" name="title" id="title"
           value="{{ old('title', $generalSetting->title ?? '') }}"
...
<div class="mb-3">
    ...
    <input type="text" name="hotel_name" id="hotel_name"
           value="{{ old('hotel_name', $generalSetting->hotel_name ?? '') }}"
...
<div class="mb-3">
    ...
    <input type="email" name="hotel_email" id="hotel_email"
           value="{{ old('hotel_email', $generalSetting->hotel_email ?? '') }}"
...
<div class="mb-3">
    ...
    <input type="tel" name="hotel_phone" id="hotel_phone"
           value="{{ old('hotel_phone', $generalSetting->hotel_phone ?? '') }}"
...
<div class="mb-3">
    ...
    <textarea name="hotel_address" id="hotel_address" rows="4"
              class="form-control @error('hotel_address') is-invalid @enderror">{{ old('hotel_address', $generalSetting->hotel_address ?? '') }}</textarea>
    @error('hotel_address')
        <div class="invalid-feedback">{{ $message }}</div>
    @enderror
</div>
...
<div class="mb-3">
    ...
    <input type="color" name="color" id="color"
           value="{{ old('color', $generalSetting->color ?? '') }}"
...
<div class="mb-3">
    ...
    <input type="text" name="cur" id="cur"
           value="{{ old('cur', $generalSetting->cur ?? '') }}"
...
<div class="mb-3">
    ...
    <input type="text" name="cur_sym" id="cur_sym"
           value="{{ old('cur_sym', $generalSetting->cur_sym ?? '') }}"
...
<div class="mb-3">
    ...
    <input type="text" name="reg" id="reg"
           value="{{ old('reg', $generalSetting->reg ?? '') }}"
...
<div class="mb-3">
    ...
    <input type="text" name="ev" id="ev"
           value="{{ old('ev', $generalSetting->ev ?? '') }}"
...
<div class="mb-3">
    ...
    <input type="text" name="mv" id="mv"
           value="{{ old('mv', $generalSetting->mv ?? '') }}"
...
<div class="mb-3">
    ...
    <input type="text" name="en" id="en"
           value="{{ old('en', $generalSetting->en ?? '') }}"
...
<div class="mb-3">
    ...
    <input type="text" name="mn" id="mn"
           value="{{ old('mn', $generalSetting->mn ?? '') }}"
...
<div class="mb-3">
    ...
    <input type="email" name="sender_email" id="sender_email"
           value="{{ old('sender_email', $generalSetting->sender_email ?? '') }}"
...
<div class="mb-3">
    ...
    <input type="email" name="email_message" id="email_message"
           value="{{ old('email_message', $generalSetting->email_message ?? '') }}"
...
<div class="mb-3">
    ...
    <textarea name="sms_api" id="sms_api" rows="4"
              class="form-control @error('sms_api') is-invalid @enderror">{{ old('sms_api', $generalSetting->sms_api ?? '') }}</textarea>
    @error('sms_api')
        <div class="invalid-feedback">{{ $message }}</div>
    @enderror
</div>
...
<div class="mb-3">
    ...
    <textarea name="meta_key_word" id="meta_key_word" rows="4"
              class="form-control @error('meta_key_word') is-invalid @enderror">{{ old('meta_key_word', $generalSetting->meta_key_word ?? '') }}</textarea>
    @error('meta_key_word')
        <div class="invalid-feedback">{{ $message }}</div>
    @enderror
</div>
...
<div class="mb-3">
    ...
    <textarea name="meta_description" id="meta_description" rows="4"
              class="form-control @error('meta_description') is-invalid @enderror">{{ old('meta_description', $generalSetting->meta_description ?? '') }}</textarea>
...
<div class="mb-3">
    ...
    <input type="text" name="meta_author" id="meta_author"
           value="{{ old('meta_author', $generalSetting->meta_author ?? '') }}"
