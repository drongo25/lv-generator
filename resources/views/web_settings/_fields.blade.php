<div class="mb-3">
    ...
    <textarea name="home_banner_section_title_1" id="home_banner_section_title_1" rows="4"
              class="form-control @error('home_banner_section_title_1') is-invalid @enderror">{{ old('home_banner_section_title_1', $webSetting->home_banner_section_title_1 ?? '') }}</textarea>
...
<div class="mb-3">
    ...
    <textarea name="home_banner_section_title_2" id="home_banner_section_title_2" rows="4"
              class="form-control @error('home_banner_section_title_2') is-invalid @enderror">{{ old('home_banner_section_title_2', $webSetting->home_banner_section_title_2 ?? '') }}</textarea>
...
<div class="mb-3">
    ...
    <textarea name="home_banner_section_title_3" id="home_banner_section_title_3" rows="4"
              class="form-control @error('home_banner_section_title_3') is-invalid @enderror">{{ old('home_banner_section_title_3', $webSetting->home_banner_section_title_3 ?? '') }}</textarea>
...
<div class="mb-3">
    ...
    <textarea name="home_about_section_title" id="home_about_section_title" rows="4"
              class="form-control @error('home_about_section_title') is-invalid @enderror">{{ old('home_about_section_title', $webSetting->home_about_section_title ?? '') }}</textarea>
...
<div class="mb-3">
    ...
    <textarea name="home_about_section_short_details" id="home_about_section_short_details" rows="4"
              class="form-control @error('home_about_section_short_details') is-invalid @enderror">{{ old('home_about_section_short_details', $webSetting->home_about_section_short_details ?? '') }}</textarea>
...
<div class="mb-3">
    ...
    <textarea name="home_about_section_long_details" id="home_about_section_long_details" rows="4"
              class="form-control @error('home_about_section_long_details') is-invalid @enderror">{{ old('home_about_section_long_details', $webSetting->home_about_section_long_details ?? '') }}</textarea>
...
<div class="mb-3">
    ...
    <input type="text" name="home_room_section_title" id="home_room_section_title"
           value="{{ old('home_room_section_title', $webSetting->home_room_section_title ?? '') }}"
...
<div class="mb-3">
    ...
    <input type="text" name="home_room_section_title_sub" id="home_room_section_title_sub"
           value="{{ old('home_room_section_title_sub', $webSetting->home_room_section_title_sub ?? '') }}"
...
<div class="mb-3">
    ...
    <textarea name="home_team_section_title_1" id="home_team_section_title_1" rows="4"
              class="form-control @error('home_team_section_title_1') is-invalid @enderror">{{ old('home_team_section_title_1', $webSetting->home_team_section_title_1 ?? '') }}</textarea>
...
<div class="mb-3">
    ...
    <textarea name="home_team_section_title_2" id="home_team_section_title_2" rows="4"
              class="form-control @error('home_team_section_title_2') is-invalid @enderror">{{ old('home_team_section_title_2', $webSetting->home_team_section_title_2 ?? '') }}</textarea>
...
<div class="mb-3">
    ...
    <input type="text" name="home_service_section_title" id="home_service_section_title"
           value="{{ old('home_service_section_title', $webSetting->home_service_section_title ?? '') }}"
...
<div class="mb-3">
    ...
    <input type="text" name="home_service_section_sub_title" id="home_service_section_sub_title"
           value="{{ old('home_service_section_sub_title', $webSetting->home_service_section_sub_title ?? '') }}"
...
<div class="mb-3">
    ...
    <input type="text" name="home_video_section_title" id="home_video_section_title"
           value="{{ old('home_video_section_title', $webSetting->home_video_section_title ?? '') }}"
...
<div class="mb-3">
    ...
    <input type="text" name="home_video_section_sub_title" id="home_video_section_sub_title"
           value="{{ old('home_video_section_sub_title', $webSetting->home_video_section_sub_title ?? '') }}"
...
<div class="mb-3">
    ...
    <input type="text" name="home_video_section_video_link" id="home_video_section_video_link"
           value="{{ old('home_video_section_video_link', $webSetting->home_video_section_video_link ?? '') }}"
...
<div class="mb-3">
    ...
    <textarea name="gallery_gallery_section_title_1" id="gallery_gallery_section_title_1" rows="4"
              class="form-control @error('gallery_gallery_section_title_1') is-invalid @enderror">{{ old('gallery_gallery_section_title_1', $webSetting->gallery_gallery_section_title_1 ?? '') }}</textarea>
...
<div class="mb-3">
    ...
    <textarea name="gallery_gallery_section_title_2" id="gallery_gallery_section_title_2" rows="4"
              class="form-control @error('gallery_gallery_section_title_2') is-invalid @enderror">{{ old('gallery_gallery_section_title_2', $webSetting->gallery_gallery_section_title_2 ?? '') }}</textarea>
...
<div class="mb-3">
    ...
    <textarea name="home_testimonial_section_title_1" id="home_testimonial_section_title_1" rows="4"
              class="form-control @error('home_testimonial_section_title_1') is-invalid @enderror">{{ old('home_testimonial_section_title_1', $webSetting->home_testimonial_section_title_1 ?? '') }}</textarea>
...
<div class="mb-3">
    ...
    <textarea name="home_testimonial_section_title_2" id="home_testimonial_section_title_2" rows="4"
              class="form-control @error('home_testimonial_section_title_2') is-invalid @enderror">{{ old('home_testimonial_section_title_2', $webSetting->home_testimonial_section_title_2 ?? '') }}</textarea>
...
<div class="mb-3">
    ...
    <input type="text" name="home_facility_section_title_1" id="home_facility_section_title_1"
           value="{{ old('home_facility_section_title_1', $webSetting->home_facility_section_title_1 ?? '') }}"
...
<div class="mb-3">
    ...
    <input type="text" name="home_facility_section_title_2" id="home_facility_section_title_2"
           value="{{ old('home_facility_section_title_2', $webSetting->home_facility_section_title_2 ?? '') }}"
...
<div class="mb-3">
    ...
    <textarea name="general_general_section_footer_content" id="general_general_section_footer_content" rows="4"
              class="form-control @error('general_general_section_footer_content') is-invalid @enderror">{{ old('general_general_section_footer_content', $webSetting->general_general_section_footer_content ?? '') }}</textarea>
...
<div class="mb-3">
    ...
    <textarea name="general_general_section_fb_comment_script" id="general_general_section_fb_comment_script" rows="4"
              class="form-control @error('general_general_section_fb_comment_script') is-invalid @enderror">{{ old('general_general_section_fb_comment_script', $webSetting->general_general_section_fb_comment_script ?? '') }}</textarea>
...
<div class="mb-3">
    ...
    <input type="text" name="blog_blog_section_title_1" id="blog_blog_section_title_1"
           value="{{ old('blog_blog_section_title_1', $webSetting->blog_blog_section_title_1 ?? '') }}"
...
<div class="mb-3">
    ...
    <input type="text" name="blog_blog_section_title_2" id="blog_blog_section_title_2"
           value="{{ old('blog_blog_section_title_2', $webSetting->blog_blog_section_title_2 ?? '') }}"
...
<div class="mb-3">
    ...
    <textarea name="faq_faq_section_title_1" id="faq_faq_section_title_1" rows="4"
              class="form-control @error('faq_faq_section_title_1') is-invalid @enderror">{{ old('faq_faq_section_title_1', $webSetting->faq_faq_section_title_1 ?? '') }}</textarea>
...
<div class="mb-3">
    ...
    <textarea name="faq_faq_section_title_2" id="faq_faq_section_title_2" rows="4"
              class="form-control @error('faq_faq_section_title_2') is-invalid @enderror">{{ old('faq_faq_section_title_2', $webSetting->faq_faq_section_title_2 ?? '') }}</textarea>
...
<div class="mb-3">
    ...
    <textarea name="contact_all_section_title_1" id="contact_all_section_title_1" rows="4"
              class="form-control @error('contact_all_section_title_1') is-invalid @enderror">{{ old('contact_all_section_title_1', $webSetting->contact_all_section_title_1 ?? '') }}</textarea>
...
<div class="mb-3">
    ...
    <textarea name="contact_all_section_title_2" id="contact_all_section_title_2" rows="4"
              class="form-control @error('contact_all_section_title_2') is-invalid @enderror">{{ old('contact_all_section_title_2', $webSetting->contact_all_section_title_2 ?? '') }}</textarea>
...
<div class="mb-3">
    ...
    <input type="tel" name="contact_all_section_phone" id="contact_all_section_phone"
           value="{{ old('contact_all_section_phone', $webSetting->contact_all_section_phone ?? '') }}"
...
<div class="mb-3">
    ...
    <input type="email" name="contact_all_section_email_web" id="contact_all_section_email_web"
           value="{{ old('contact_all_section_email_web', $webSetting->contact_all_section_email_web ?? '') }}"
...
<div class="mb-3">
    ...
    <textarea name="contact_all_section_address" id="contact_all_section_address" rows="4"
              class="form-control @error('contact_all_section_address') is-invalid @enderror">{{ old('contact_all_section_address', $webSetting->contact_all_section_address ?? '') }}</textarea>
...
<div class="mb-3">
    ...
    <textarea name="contact_all_section_map" id="contact_all_section_map" rows="4"
              class="form-control @error('contact_all_section_map') is-invalid @enderror">{{ old('contact_all_section_map', $webSetting->contact_all_section_map ?? '') }}</textarea>
