<div class="mb-3">
    ...
    <input type="number" name="room_type_id" id="room_type_id"
           value="{{ old('room_type_id', $regularPrice->room_type_id ?? '') }}"
...
<div class="mb-3">
    ...
    <input type="text" name="day_1" id="day_1"
           value="{{ old('day_1', $regularPrice->day_1 ?? '') }}"
...
<div class="mb-3">
    ...
    <input type="number" name="day_1_amount" id="day_1_amount"
           value="{{ old('day_1_amount', $regularPrice->day_1_amount ?? '') }}"
...
<div class="mb-3">
    ...
    <input type="text" name="day_2" id="day_2"
           value="{{ old('day_2', $regularPrice->day_2 ?? '') }}"
...
<div class="mb-3">
    ...
    <input type="number" name="day_2_amount" id="day_2_amount"
           value="{{ old('day_2_amount', $regularPrice->day_2_amount ?? '') }}"
...
<div class="mb-3">
    ...
    <input type="text" name="day_3" id="day_3"
           value="{{ old('day_3', $regularPrice->day_3 ?? '') }}"
...
<div class="mb-3">
    ...
    <input type="number" name="day_3_amount" id="day_3_amount"
           value="{{ old('day_3_amount', $regularPrice->day_3_amount ?? '') }}"
...
<div class="mb-3">
    ...
    <input type="text" name="day_4" id="day_4"
           value="{{ old('day_4', $regularPrice->day_4 ?? '') }}"
...
<div class="mb-3">
    ...
    <input type="number" name="day_4_amount" id="day_4_amount"
           value="{{ old('day_4_amount', $regularPrice->day_4_amount ?? '') }}"
...
<div class="mb-3">
    ...
    <input type="text" name="day_5" id="day_5"
           value="{{ old('day_5', $regularPrice->day_5 ?? '') }}"
...
<div class="mb-3">
    ...
    <input type="number" name="day_5_amount" id="day_5_amount"
           value="{{ old('day_5_amount', $regularPrice->day_5_amount ?? '') }}"
...
<div class="mb-3">
    ...
    <input type="text" name="day_6" id="day_6"
           value="{{ old('day_6', $regularPrice->day_6 ?? '') }}"
...
<div class="mb-3">
    ...
    <input type="number" name="day_6_amount" id="day_6_amount"
           value="{{ old('day_6_amount', $regularPrice->day_6_amount ?? '') }}"
...
<div class="mb-3">
    ...
    <input type="text" name="day_7" id="day_7"
           value="{{ old('day_7', $regularPrice->day_7 ?? '') }}"
...
<div class="mb-3">
    ...
    <input type="number" name="day_7_amount" id="day_7_amount"
           value="{{ old('day_7_amount', $regularPrice->day_7_amount ?? '') }}"
