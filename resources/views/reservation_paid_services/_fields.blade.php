<div class="mb-3">
    ...
    <input type="number" name="reservation_id" id="reservation_id"
           value="{{ old('reservation_id', $reservationPaidService->reservation_id ?? '') }}"
...
<div class="mb-3">
    ...
    <input type="number" name="pad_service_id" id="pad_service_id"
           value="{{ old('pad_service_id', $reservationPaidService->pad_service_id ?? '') }}"
...
<div class="mb-3">
    ...
    <input type="text" name="price_type" id="price_type"
           value="{{ old('price_type', $reservationPaidService->price_type ?? '') }}"
...
<div class="mb-3">
    ...
    <input type="number" name="value" id="value"
           value="{{ old('value', $reservationPaidService->value ?? '') }}"
...
<div class="mb-3">
    ...
    <input type="number" name="price" id="price"
           value="{{ old('price', $reservationPaidService->price ?? '') }}"
