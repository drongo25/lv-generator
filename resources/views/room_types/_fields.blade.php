...
<div class="mb-3">
    ...
    <input type="text" name="short_code" id="short_code"
           value="{{ old('short_code', $short_code ?? '') }}"
...
<div class="mb-3">
    ...
    <textarea name="description" id="description" rows="4"
              class="form-control @error('description') is-invalid @enderror">{{ old('description', $description ?? '') }}</textarea>
    @error('description')
        <div class="invalid-feedback">{{ $message }}</div>
    @enderror
</div>
...
<div class="mb-3">
    ...
    <input type="number" name="base_capacity" id="base_capacity"
           value="{{ old('base_capacity', $base_capacity ?? '') }}"
...
<div class="mb-3">
    ...
    <input type="number" name="higher_capacity" id="higher_capacity"
           value="{{ old('higher_capacity', $higher_capacity ?? '') }}"
...
<div class="mb-3">
    ...
    <input type="number" name="kids_capacity" id="kids_capacity"
           value="{{ old('kids_capacity', $kids_capacity ?? '') }}"
...
<div class="mb-3">
    ...
    <input type="number" name="base_price" id="base_price"
           value="{{ old('base_price', $base_price ?? '') }}"
...
<div class="mb-3">
    ...
    <input type="number" name="additional_person_price" id="additional_person_price"
           value="{{ old('additional_person_price', $additional_person_price ?? '') }}"
...
<div class="mb-3">
    ...
    <input type="number" name="extra_bed_price" id="extra_bed_price"
           value="{{ old('extra_bed_price', $extra_bed_price ?? '') }}"
