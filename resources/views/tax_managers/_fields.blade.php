<div class="mb-3">
    ...
    <input type="text" name="name" id="name"
           value="{{ old('name', $taxManager->name ?? '') }}"
...
<div class="mb-3">
    ...
    <input type="text" name="code" id="code"
           value="{{ old('code', $taxManager->code ?? '') }}"
...
<div class="mb-3">
    ...
    <input type="text" name="type" id="type"
           value="{{ old('type', $taxManager->type ?? '') }}"
...
<div class="mb-3">
    ...
    <input type="number" name="rate" id="rate"
           value="{{ old('rate', $taxManager->rate ?? '') }}"
...
<div class="mb-3">
    ...
    <input type="text" name="status" id="status"
           value="{{ old('status', $taxManager->status ?? '') }}"
