<div class="mb-3">
    ...
    <input type="text" name="title" id="title"
           value="{{ old('title', $paidService->title ?? '') }}"
...
<div class="mb-3">
    ...
    <input type="text" name="price_type" id="price_type"
           value="{{ old('price_type', $paidService->price_type ?? '') }}"
...
<div class="mb-3">
    ...
    <input type="number" name="price" id="price"
           value="{{ old('price', $paidService->price ?? '') }}"
...
<div class="mb-3">
    ...
    <textarea name="short_desc" id="short_desc" rows="4"
              class="form-control @error('short_desc') is-invalid @enderror">{{ old('short_desc', $paidService->short_desc ?? '') }}</textarea>
    @error('short_desc')
        <div class="invalid-feedback">{{ $message }}</div>
    @enderror
</div>
...
<div class="mb-3">
    ...
    <textarea name="long_desc" id="long_desc" rows="4"
              class="form-control @error('long_desc') is-invalid @enderror">{{ old('long_desc', $paidService->long_desc ?? '') }}</textarea>
    @error('long_desc')
        <div class="invalid-feedback">{{ $message }}</div>
    @enderror
</div>
...
<div class="mb-3">
    ...
    <input type="text" name="status" id="status"
           value="{{ old('status', $paidService->status ?? '') }}"
