...
class WebOurClientFeedbackController extends Controller
{
    ...
    {
        // FIX: передаём пустую модель — _fields использует $webOurClientFeedback->field ?? ''
        $webOurClientFeedback = new WebOurClientFeedback();
        return view('web_our_client_feedbacks.create', compact('webOurClientFeedback'));
    }
    ...
    public function update(UpdateWebOurClientFeedbackRequest $request, $id)
    {
        $webOurClientFeedback = WebOurClientFeedback::findOrFail($id);
